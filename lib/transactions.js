...
TxController.prototype.transformTransaction = function(transaction, options, callback) {
  ...
  if(transaction.height >= 0) {
    confirmations = this.node.services.fantasygoldd.height - transaction.height + 1;
  }
  ...
  var transformed = {
    ...
    isfgc20Transfer: transaction.isfgc20Transfer,
  };
...
TxController.prototype.transformFantasyGoldTransaction = function(transaction) {
